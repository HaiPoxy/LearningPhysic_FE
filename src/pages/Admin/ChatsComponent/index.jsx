                ...
                <CardContent>
                    ...
                    <Box sx={{display: 'flex', justifyContent: 'space-between', mb: 3}}>
                        ...
                        <Button
                            ...
                            sx={{minWidth: 40, padding: 0}} // Adjust the button size to fit the icon
                        >
                            <AddIcon/> {/* This is the icon replacing the text */}
                        </Button>
                    </Box>
                        ...
                        <TableBody>
                            {questions.map((question) => (
                                <TableRow key={question.id}>
                                    ...
                                    <TableCell>
                                        <IconButton size="small" color="info" onClick={() => viewQuestion(question.id)}>
                                            <VisibilityIcon/>
                                        </IconButton>
                                        ...
                                        <IconButton size="small" color="secondary"
                                                    onClick={() => viewAllAnswers(question.id)}>
                                            <ListIcon/>
                                        </IconButton>
                                    </TableCell>
                                </TableRow>
