    ...
    return (
        <div className="container-fluid mt-4">
            <div className="row">
                ...
                <div className="col-md-4" style={{ padding: '15px', border: '1px solid #ccc', borderRadius: '5px', height: '600px' }}>
                    <div className="row">
                        {buttons.map((number) => (
                    ...
                    <div>
                        <h4 style={{ fontSize: '24px' }}>Thời gian còn lại: {formatTime(timeLeft)}</h4>
                    </div>
                </div>

                <div className="col-md-8" style={{ padding: '15px', border: '1px solid #ccc', borderRadius: '5px', height: '600px' }}>
                    <h3 style={{ fontSize: '28px' }}>Câu hỏi {currentQuestion}</h3>
                    {className === "Lớp 6" ? (
                        <Question
                    ...
                    {submitted && (
                        <div className="mt-4">
                            <h4 style={{ fontSize: '24px' }}>Điểm số: {score} / {buttons.length}</h4>
